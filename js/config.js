...
// Supabase: Project Settings > API. The anon key is safe to expose in a public
// site because Row Level Security protects writes.
export const SUPABASE_URL = "https://qjjmcqfgalqowgbxaqpp.supabase.co";
export const SUPABASE_ANON_KEY = "sb_publishable_Hp1wV6DD6twu8hWDAC-16g_NWMCdwLI";
